...
--
-- Host: localhost
-- Generation Time: Sep 01, 2022 at 01:06 PM
...
--
-- Database: `content_detection_and_classification_of_youtube_videos`
--
CREATE DATABASE IF NOT EXISTS `content_detection_and_classification_of_youtube_videos` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `content_detection_and_classification_of_youtube_videos`;
...
('jhgjwtzen8i847ym5n3nfe5b8oxhwoc9', 'eyJ1c2VyaWQiOjZ9:1oTiH0:E5ptdu_OP7yB3grjwfqEyT5RxC9JzABCbx5mYVvE_sM', '2022-09-15 11:22:14.015892'),
...
('yjmo4ii0hwpx557lcadcpiehgak7kfbq', 'eyJ1c2VyaWQiOjh9:1oTjob:ptDiGVC8m_cWHUJU-R0zCcpsxuMC-gxf1tjsS4tNPJA', '2022-09-15 13:01:01.637468'),
...
(6, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
(7, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
(8, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,8th Cross,Vijayanagar', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_content_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_content_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `video_id` varchar(3000) NOT NULL,
  `title` varchar(3000) NOT NULL,
  `channel_title` varchar(3000) NOT NULL,
  `category` varchar(3000) NOT NULL,
  `publish_time` varchar(3000) NOT NULL,
  `content` varchar(3000) NOT NULL,
  `views` varchar(3000) NOT NULL,
  `likes` varchar(3000) NOT NULL,
  `dislikes` varchar(3000) NOT NULL,
  `comment_count` varchar(3000) NOT NULL,
  `Video_link` varchar(3000) NOT NULL,
  `publish_date` varchar(3000) NOT NULL,
  `views_per_day` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_content_detection_type`
--

INSERT INTO `remote_user_content_detection_type` (`id`, `video_id`, `title`, `channel_title`, `category`, `publish_time`, `content`, `views`, `likes`, `dislikes`, `comment_count`, `Video_link`, `publish_date`, `views_per_day`, `Prediction`) VALUES
(1, 'il_pSa5l98w', 'MCA (Middle Class Abbayi) TEASER - Nani,Sai Pallavi, Dil Raju, Devi Sri Prasad, Sriram Venu', 'Dil Raju', 'Entertainment', '4:29:50', 'Nenu Local|"Nenu Local Telugu Movie"|"Nani"|"Sai Pallavi"|"Dil Raju"|"Devi Sri Prasad"|"Telugu Latest Movies"|"Telugu Full Movies"|"Telugu Comedy Movies"|"Nani Trailer"|"Nani Movies"|"MCA MOVIE"|"Middle Class Abbayi"|"MCA"|"MCA - Middle class abbayi"|"Fidaa"|"Nani MCA"|"MCA Trailer"|"MCA Teaser"|"MCA First Look"|"Nani MCA Teaser"|"Nani MCA Trailer"\r\n', '6106669', '98612', '4185', '4763', 'https://i.ytimg.com/vi/il_pSa5l98w/default.jpg', '10-11-17', '1526667.25', 'True Content'),
(2, 'zOOmEDwPJX0', 'Jannat (Full Song) Aatish - Latest Punjabi Song 2017 - New Punjabi Songs 2017 - WHM', 'White Hill Music', 'Music', '12:02:09', 'Aatish new punjabi song 2017|"latest punjabi songs 2017 Aatish"|"new punjabi songs 2017 Jannat"|"latest punjabi song 2017 Jannat"|"new songs 2017 Aatish"|"latest song 2017 Aatish"|"Aatish"|"punjabi songs 2017 Aatish"|"punjabi music videos Aatish"|"Jannat punjabi song 2017"|"new punjabi songs"|"latest punjabi songs"|"new songs"|"latest songs"|"songs 2017"|"punjabi"|"Aatish songs"|"Jannat by Aatish"|"punjabi song"|"whte hill"|"aatish taare"|"romantic songs punjabi"\r\n', '2348107', '32834', '710', '1743', 'https://i.ytimg.com/vi/zOOmEDwPJX0/default.jpg', '11-11-17', '782702.3333', 'False Content'),
(3, 'KHxdrECEsD0', 'Peehu Srivastav Performs On Daiya Yeh Main kahan Aa Phasi | The Voice India Kids | Episode 1', 'The Voice India Kids', 'Entertainment', '19:19:13', 'the voice of india|"TVOI"|"the voice of india kids"|"audition"|"singers"|"singing talent"|"kids voice"|"kids singing"|"kids talent"|"Talpa media"|"AndTV"|"&TV"\r\n', '472413', '2611', '250', '174', 'https://i.ytimg.com/vi/KHxdrECEsD0/default.jpg', '11-11-17', '157471', 'True Content'),
(4, 'QYNymjtl_QE', 'SHRIMAD BHAGWAT KATHA - BHADOHI DAY- 4', 'Shri Devkinandan Thakur Ji', 'People & Blogs', '17:26:34', 'Shri Devkinandan ji|"à¤¦à¥‡à¤µà¤•à¥€à¤¨à¤‚à¤¦à¤¨ à¤œà¥€ à¤®à¤¹à¤¾à¤°à¤¾à¤œ à¤•à¥€ à¤•à¤¥à¤¾"|"Shrimad Bhagvat katha Audio"|"shrimad bhagvat katha"|"thakur ji ke bhajan mp3"\r\n', '20086', '1059', '28', '61', 'https://i.ytimg.com/vi/QYNymjtl_QE/default.jpg', '12-11-17', '10043', 'False Content');
...
(39, 'Naive Bayes', '57.743273992772046'),
(40, 'SVM', '58.53299424441173'),
(41, 'Logistic Regression', '59.28255922901887'),
(42, 'Decision Tree Classifier', '58.10467139606479');
